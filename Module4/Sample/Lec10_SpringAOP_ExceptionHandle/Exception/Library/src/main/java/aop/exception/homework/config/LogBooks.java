...
public class LogBooks {
    @AfterThrowing(pointcut = "execution(public * aop.exception.homework.service.impl.BookServiceImpl.*(..))",
            throwing = "e")
    ...
    @After("execution(public * aop.exception.homework.service.impl.BookServiceImpl.save(..))" + " || execution(public * aop.exception.homework.service.impl.BookServiceImpl.borrow(..))"
            + " || execution(public * aop.exception.homework.service.impl.BookServiceImpl.giveBack(..))")
